        ...
        <div className='container'>
          <div className='grid md:grid-cols-3 py-5 bg-gray-200 rounded-t-xl'>
            <div className='py-8 px-4'>
              ...
              <p className='text-sm'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde facere ab hic accusamus omnis dolor
                voluptatibus illo, tempore eum tenetur.
              </p>
              <br />
            ...
            <p className='text-center items-center justify-center mx-auto border-t-2 border-gray-300/50 bg-primary text-black'>
